...
|_   _| |_  ___  | \\| |___ _ _ / __| __ _| | |_   _| _ __ _(_) |
  | | | ' \\/ -_) | .\` / _ \\ '_| |  (__/ _\` | |   | || '_/ _\` | | |
  |_| |_||_\\___| |_|\\_\\___/_|  \\___\\__,_|_|   |_||_| \\__,_|_|_|
        </pre>
  ...
  startStreetPerformance() {
    ...
    eventContainer.innerHTML = `
      <div style="text-align: center; padding: 2rem;">
        ...
        <div style="margin-top: 1rem; display: flex; justify-content: center; gap: 0.5rem; align-items: center; max-width: 100%; overflow: hidden;">
          <button id="note1Btn" style="font-size: 1.5rem; padding: 0.75rem 1.25rem; background: rgba(255, 107, 107, 0.3); border: 2px solid #ff6b6b; min-width: 0; max-width: 30%;">🎵</button>
          <button id="note2Btn" style="font-size: 1.5rem; padding: 0.75rem 1.25rem; background: rgba(77, 222, 128, 0.3); border: 2px solid #4ade80; min-width: 0; max-width: 30%;">🎶</button>
          <button id="note3Btn" style="font-size: 1.5rem; padding: 0.75rem 1.25rem; background: rgba(139, 92, 246, 0.3); border: 2px solid #8b5cf6; min-width: 0; max-width: 30%;">🎸</button>
        </div>
      </div>
    `;
